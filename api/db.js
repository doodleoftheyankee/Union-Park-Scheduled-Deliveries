...
const db = createClient({
  url: process.env.TURSO_DATABASE_URL || 'file:deliveries.db',
...
export async function initDb() {
  ...
  await db.execute('CREATE INDEX IF NOT EXISTS idx_appointments_salesperson ON appointments(salesperson)');
